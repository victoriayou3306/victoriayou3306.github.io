...
const PROJECTS = [
  ...
  {
    id: "asme_pd",
    name: "ASME Product Development",
    cat: "Club",
    dateStart: "2026-04",
    date: "present",
    desc: "Product Development Director for ASME @ Illinois",
    body: "",
    tags: ["Project Management"],
    toc: true,    tocOffset: '4rem',   tocTop: '1.5rem',
    sidebar:[{title: "Co-director:", content: "<a href = 'https://www.linkedin.com/in/sergio-bahena3/'><strong>Sergio Bahena</strong></a>"}],
    // coverImage: "ASME_Logo.png",
  },
  {
    id: "keyboard",
